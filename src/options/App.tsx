    ...
    <div className="container mx-auto">
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">ChatGPT Scailability</span>
        </div>
        <div className="flex flex-row gap-3">
          ...
          <a
            href="mailto:info@scailability.com"
            target="_blank"
            rel="noreferrer"
          >
            Feedback via email
          </a>
          <a href="https://twitter.com/scailability" target="_blank" rel="noreferrer">
            Twitter
          </a>
          <a
            href="https://github.com/eliasak/scailability-browser-extension"
            target="_blank"
            rel="noreferrer"
          >
            Source code
      ...
      <footer className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          <span class="footnotes">This project contains source code that was forked from <a href="https://github.com/wong2/chat-gpt-google-extension/issues" target="_blank" rel="noreferrer">https://github.com/wong2/chatgpt-google-extension</a>. 
            We would like to thank the original author (https://chatgpt4google.com/) for making their code available and allowing us to use and build upon it</span>
        </div>
      </footer>
